...
module "ecs_service" {
  ...
  memory = 4096
  name   = "my-cluster-my-application-a"
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "my-cluster-my-application-a"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "ed555bd3-c56e-4415-8b38-e27fb9ec75ee"
