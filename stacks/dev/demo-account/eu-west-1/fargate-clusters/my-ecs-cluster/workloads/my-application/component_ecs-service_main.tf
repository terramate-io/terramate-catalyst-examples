...
module "ecs_service" {
  ...
  memory = 4096
  name   = "my-ecs-cluster-my-application"
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "my-ecs-cluster-my-application"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "c432a417-5b05-45f9-8bdf-a9e2daf7e2f1"
