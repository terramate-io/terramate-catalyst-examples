...
module "ecs_service" {
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "demo-cluster-my-second-service"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "62858725-14ac-4886-8176-c07e7f8bf429"
