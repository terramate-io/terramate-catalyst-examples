...
module "ecs_service" {
  ...
  memory = 4096
  name   = "demo-cluster-my-application"
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "demo-cluster-my-application"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "ff8fa4a3-5286-4737-87a2-a92927ddf40e"
