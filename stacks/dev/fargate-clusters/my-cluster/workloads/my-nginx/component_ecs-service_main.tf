...
module "ecs_service" {
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "my-cluster-my-nginx"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "a2356afb-0e6f-4dcb-b209-67cd2c25c2a6"
