...
module "ecs_service" {
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "catalyst-ecs-catalyst-nginx"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "671dcac3-3e1c-4635-afec-57f7a3fa5b48"
