...
module "ecs_service" {
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "ecs-fargate-prd-prd-nginx-prd"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "63b17289-7695-4b86-860a-9172efa51f68"
  }
  version = "6.1.0"
}
