...
module "ecs_service" {
  ...
  tags = {
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-alias" = "main-cluster-application-a"
    "example.com/tf-aws-ecs-fargate-service/v1/bundle-uuid"  = "64cc4ef4-f26b-43f9-a127-ceecc2322646"
